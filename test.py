...
當使用者進入http://pcdw0904017/rdmplog/LogSummary.jsp這個網頁時我想要紀錄下使用者的名稱,IP位址,REPORT,以及當下時間，
然後將這些資訊INSERT到INSERT INTO [WebPlatForm].[dbo].[WebPlatForm_Counter] ([IP], [USER], [REPORT], [CLICK_TIME]) ，請幫我改寫程式碼，謝謝。
